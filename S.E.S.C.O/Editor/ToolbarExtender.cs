...
namespace DevelopKit.BasicTemplate
{
	...
	public static class ToolbarExtender
	{
		...
		public static readonly List<Action> OnLeftToolbarGUI = new ();
		public static readonly List<Action> OnRightToolbarGUI = new ();
		...
		static void OnGUI()
		{
			...
			if (leftRect.width > 0)
			{
				...
				foreach (var handler in OnLeftToolbarGUI)
				{
					handler();
				}
			...
			if (rightRect.width > 0)
			{
				...
				GUILayout.BeginHorizontal();
				foreach (var handler in OnRightToolbarGUI)
				{
					handler();
				}
