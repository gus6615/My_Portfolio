...
namespace DevelopKit.BasicTemplate
{
    public class TestUp : MonoBehaviour
    {
        private async void Awake()
        {
            ...
            await UniTask.WaitUntil(() => ( ManagerHub.Data.UnitDataSOList.Count != 0 && ManagerHub.Data.PartDataSOList.Count != 0 && ManagerHub.Data.ProjectileDataSOList.Count != 0));
            FindObjectOfType<InGameManager>().OnEnter();
        }
